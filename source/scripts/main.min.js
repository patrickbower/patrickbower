...
var InView = exports.InView = function () {
    ...
    _createClass(InView, [{
        ...
        value: function setClasses() {
            ...
            Array.from(this.elementsArray).forEach(function (element) {
        ...
        value: function scrollIntoViewPort(nextReadyElement) {
            var nextElement = document.querySelector(nextReadyElement);
