...
var modules = (_modules = {}, _defineProperty(_modules, 'in-view', _inView.InView), _defineProperty(_modules, 'model', _modelLaunch.ModelLaunch), _defineProperty(_modules, 'back-button', _backButton.BackButton), _defineProperty(_modules, 'contact', _contactForm.ContactForm), _defineProperty(_modules, 'email', _email.Email), _modules);

exports.modules = modules;

},{"./back-button":3,"./contact-form":4,"./email":5,"./in-view":6,"./model-launch":7}],3:[function(require,module,exports){
'use strict';
...
var InView = exports.InView = function () {
    ...
    _createClass(InView, [{
        ...
        value: function scrollIntoViewPort(nextElement) {
            var element = document.querySelector(nextElement);
        ...
        key: 'testViewPort',
        value: function testViewPort(element) {
        ...
        key: 'pageReturnTest',
        value: function pageReturnTest() {
            var instance = this;
            var allItems = document.querySelectorAll('.' + this.selectors.item);
...
},{"../utilities/_utilities":10,"./model-window":8}],8:[function(require,module,exports){
'use strict';
