...
var modules = (_modules = {}, _defineProperty(_modules, 'in-view', _inView.InView), _defineProperty(_modules, 'back-button', _backButton.BackButton), _defineProperty(_modules, 'modal', _modal.Modal), _defineProperty(_modules, 'contact', _contactForm.ContactForm), _defineProperty(_modules, 'modal-events', _modalEvents.ModalEvents), _defineProperty(_modules, 'email', _email.Email), _modules);
...
},{"./_settings":9,"./ajax":11,"./breakpoint":12,"./capitalise":13,"./init":14,"./parsehtml":15,"./trigger":16}],11:[function(require,module,exports){
'use strict';
