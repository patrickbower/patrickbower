...
},{"./utilities/init":11}],2:[function(require,module,exports){
'use strict';
...
},{"./contact-form":3,"./model-launch":4}],3:[function(require,module,exports){
'use strict';
    ...
    _createClass(ContactForm, [{
        ...
        */
        ...
        value: function submitForm() {
            ...
            var form = this.context.querySelector('.' + defaults.selectors.contact_form);
        ...
        value: function confirmSubmit() {
            ...
            var contact_section = this.context.querySelector('.' + defaults.selectors.contact_section);
...
},{"../utilities/_utilities":7}],4:[function(require,module,exports){
'use strict';
...
},{"../utilities/_utilities":7,"./model-window":5}],5:[function(require,module,exports){
'use strict';
...
},{"../utilities/_utilities":7}],6:[function(require,module,exports){
"use strict";
...
},{"./_settings":6,"./ajax":8,"./breakpoint":9,"./capitalise":10,"./init":11,"./parsehtml":12}],8:[function(require,module,exports){
'use strict';
...
},{"./parsehtml":12}],9:[function(require,module,exports){
'use strict';
...
function init(context) {
    ...
    // for each occurance
    Array.from(js_modules).forEach(function (html_fragment) {

        // get class name
        var js_class = html_fragment.getAttribute('data-init');

        // instantiate
        var module_instance = new _modules.modules[js_class](html_fragment);
...
},{"../modules/_modules":2}],12:[function(require,module,exports){
'use strict';
