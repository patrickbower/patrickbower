...
var modules = (_modules = {}, _defineProperty(_modules, 'in-view', _inView.InView), _defineProperty(_modules, 'back-button', _backButton.BackButton), _defineProperty(_modules, 'modal', _modal.Modal), _defineProperty(_modules, 'contact', _contactForm.ContactForm), _defineProperty(_modules, 'email', _email.Email), _modules);

exports.modules = modules;

},{"./back-button":3,"./contact-form":4,"./email":5,"./in-view":6,"./modal":7}],3:[function(require,module,exports){
'use strict';
...
},{"../utilities/_utilities":9}],7:[function(require,module,exports){
'use strict';
...
var Modal = exports.Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function bindStartEvents() {
            ...
            var start_modal_event = {
                handleEvent: function handleEvent(event) {
                    event.preventDefault();
                    var hash = instance.getHash(event.currentTarget);
                    instance.setHash(hash);
                }
            };

            var startButtons = document.querySelectorAll('.' + this.selectors.start_button);
            Array.from(startButtons).forEach(function (button) {
        ...
        key: 'getHash',
        value: function getHash(currentTarget) {
            return document.querySelector('[data-stamp=' + window.location.hash + ']');

            var _currentTarget$href$s = currentTarget.href.split('#');

            var _currentTarget$href$s2 = _slicedToArray(_currentTarget$href$s, 2);

            var url = _currentTarget$href$s2[0];
            var hash = _currentTarget$href$s2[1];
...
exports.trigger = exports.parseHTML = exports.capitalise = exports.breakpoint = exports.ajax = exports.init = exports.settings = undefined;
...
},{"./_settings":8,"./ajax":10,"./breakpoint":11,"./capitalise":12,"./init":13,"./parsehtml":14,"./trigger":15}],10:[function(require,module,exports){
'use strict';
