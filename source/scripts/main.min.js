...
var _getModules = require('./utilities/get-modules');
...
window.onload = function () {
  (0, _init.init)((0, _getModules.getHtmlModules)(document));
};

},{"./utilities/get-modules":14,"./utilities/init":15}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.auto_init = exports.modules = undefined;
...
var _modalEvents = require('./modal-events');

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var modules = (_modules = {}, _defineProperty(_modules, 'in-view', _inView.InView), _defineProperty(_modules, 'back-button', _backButton.BackButton), _defineProperty(_modules, 'modal', _modal.Modal), _defineProperty(_modules, 'modal-events', _modalEvents.ModalEvents), _defineProperty(_modules, 'contact', _contactForm.ContactForm), _defineProperty(_modules, 'email', _email.Email), _modules);
...
exports.auto_init = auto_init;

},{"./back-button":3,"./contact-form":4,"./email":5,"./in-view":6,"./modal":8,"./modal-events":7}],3:[function(require,module,exports){
'use strict';
...
var ModalEvents = exports.ModalEvents = function () {
    ...
    function ModalEvents() {
        ...
        _classCallCheck(this, ModalEvents);
...
var Modal = exports.Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        key: 'bindStartEvents',
        value: function bindStartEvents() {
            var instance = this;
            ...
            var modalParent = document.querySelector('.' + this.selectors.modal_parent);
...
exports.getHtmlModules = exports.trigger = exports.parseHTML = exports.capitalise = exports.breakpoint = exports.ajax = exports.init = exports.settings = undefined;
...
exports.trigger = _trigger.trigger;
exports.getHtmlModules = _getModules.getHtmlModules;

},{"./_settings":9,"./ajax":11,"./breakpoint":12,"./capitalise":13,"./get-modules":14,"./init":15,"./parsehtml":16,"./trigger":17}],11:[function(require,module,exports){
'use strict';
...
},{"./parsehtml":16}],12:[function(require,module,exports){
'use strict';
...
exports.getHtmlModules = getHtmlModules;
/**
* Find and return array of js modules
*
* @function getHtmlModules
* @param {object} context - HTML Fragment to look for data-init.
* @return {array} js_modules - js modules list.
*/

function getHtmlModules(context) {
...
*
* @function init
* @param {array} js_moduleArray - list of objects with classname and element
*/
function init(js_moduleArray) {

    // merge auto init and html js module arrays
    js_moduleArray.concat(_modules.auto_init);

    // for each occurance
    Array.from(js_moduleArray).forEach(function (module) {

        var properties = {};
        properties.element = module.element;

        // instantiate
        var module_instance = new _modules.modules[module.className](properties);
...
},{"../modules/_modules":2}],16:[function(require,module,exports){
"use strict";
...
function trigger(element, eventName, props) {
